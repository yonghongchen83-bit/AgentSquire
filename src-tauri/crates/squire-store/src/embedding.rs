...
mod tests {
    ...
    fn fallback_deterministic() {
        let a = fallback_embed("test input");
        let b = fallback_embed("test input");
        assert_eq!(a, b);
    }

    #[test]
    fn fallback_different_inputs() {
        let a = fallback_embed("hello world");
        let b = fallback_embed("goodbye world");
        assert_ne!(a, b);
    }
}
