...
export const PROVIDERS: ProviderCategory[] = [
  ...
  },
  {
    ...
    canFetchModels: true,
    knownModels: [
      { id: 'openai/gpt-4o', metadata: { max_context: '128000', vision: 'true' } },
      { id: 'openai/gpt-4o-mini', metadata: { max_context: '128000', vision: 'true' } },
      { id: 'openai/o3-mini', metadata: { max_context: '200000', thinking_format: 'reasoning_content' } },
      { id: 'deepseek/deepseek-chat', metadata: { max_context: '128000', thinking_format: 'reasoning_content' } },
      { id: 'deepseek/deepseek-r1', metadata: { max_context: '128000', thinking_format: 'reasoning_content' } },
      { id: 'anthropic/claude-sonnet-4', metadata: { max_context: '200000', thinking_format: 'thinking_block' } },
      { id: 'anthropic/claude-3.5-sonnet', metadata: { max_context: '200000' } },
      { id: 'google/gemini-2.0-flash-001', metadata: { max_context: '1000000' } },
      { id: 'meta-llama/llama-3.1-70b-instruct', metadata: { max_context: '128000' } },
      { id: 'mistralai/mistral-large', metadata: { max_context: '128000' } },
      { id: 'qwen/qwen-2.5-72b-instruct', metadata: { max_context: '128000' } },
    ],
  },
  {
    id: 'google-ai-studio',
    ...
    canFetchModels: true,
    knownModels: [
      { id: 'gemini-2.5-pro-exp-03-25', label: 'Gemini 2.5 Pro (experimental)', metadata: { max_context: '1000000', thinking_format: 'reasoning_effort' } },
      { id: 'gemini-2.5-flash-preview-04-17', label: 'Gemini 2.5 Flash (preview)', metadata: { max_context: '1000000', thinking_format: 'reasoning_effort' } },
      { id: 'gemini-2.0-flash', metadata: { max_context: '1000000' } },
      { id: 'gemini-2.0-flash-lite', metadata: { max_context: '1000000' } },
      { id: 'gemini-2.0-flash-lite-preview-02-05', label: 'Gemini 2.0 Flash Lite (preview)', metadata: { max_context: '1000000' } },
      { id: 'gemini-1.5-pro', metadata: { max_context: '2000000' } },
      { id: 'gemini-1.5-flash', metadata: { max_context: '1000000' } },
      { id: 'gemini-1.5-flash-8b', metadata: { max_context: '1000000' } },
    ],
  },
  {
    id: 'custom',
